<template>
  <div class="goods-info">
    ...
    <!-- 配置选择 -->
    <goods-info-chose-box v-on:idInfoByChoseBox="idInfoByChoseBox" :title="title"  :banUrl="banUrl" :familyName="familyName" :onceColor="onceColor" :onceSpec="onceSpec"></goods-info-chose-box>
    <!-- 配送 -->
     <div class="goods-info-send">
        ...
        <div>
            <p class="mod-bd">本商品由<strong>魅族</strong>负责发货并提供售后服务</p>
        </div>
    </div>
    <!-- 推荐购买 -->
...
export default {
    data(){
        return  {
          title:[],//axios传的所有参数
          idInfo:{}, familyName:"",subtitle:"",price:0,color:[],spec:[],banUrl:[],
          onceColor:'',onceSpec:'', //传参传参传参
          imgUrl:[],
          selected:'',
          isHeaderTrue:false, 
    ...
    methods:{
        getGoodsInfo(){
            ...
            console.log(id)
            this.$axios.get('/products/goodsinfo',{ params:{id} }).then((result)=>{
                ...
                this.banUrl=[img.ban_url1,img.ban_url2,img.ban_url3,img.ban_url4]
                //商品详情页
        ...
        idInfoByChoseBox (idInfoByChoseBox) { //父子传参

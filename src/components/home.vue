    ...
    <div id="app-home">
        ...
        <mt-swipe :auto="3000">
            <mt-swipe-item v-for="l in bannerList" :key="l.id">
              <a :href="l.href"><img :src="l.banner_url" alt=""></a>
            </mt-swipe-item>
        </mt-swipe> 
        <!-- mui的9宫格 -->
        <ul class="mui-table-view mui-grid-view mui-grid-9">
            ...
            <li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3"><a href="#/me">
                    <img src="../assets/img/grid3.png" alt="">
                    <div class="mui-media-body">我的订单</div></a></li>
            <li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3"><a href="#/goodslist">
                    <img src="../assets/img/grid4.png" alt="">
                    <div class="mui-media-body">分类</div></a></li>
		</ul>
        <!-- 单张轮播图 -->
        <mt-swipe>
            <mt-swipe-item><a href="#/home/goodsinfo/101"><img :src="bannerOne.banner_url" alt=""></a></mt-swipe-item>
        </mt-swipe>
        <!-- 推荐购买 -->
        <div class="app-home-grids" >
            <a v-for="g in grids" :key="g.id" :href="g.href"><img :src="g.grid" alt=""></a>
        </div>
...
export default {
    ...
    methods:{
        getBanner(){
            this.$axios.get('/index/bannerList' ,{
                params:{
                     //get方式下, 随url发送的参数
                }
            }).then(res=>{
